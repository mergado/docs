...
Event hook called when Mergado is about to start import process of a project. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when Mergado finished project's import process. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
### `process.apply.start`
Event hook called when is about to start import process of a project. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when finished project's import process. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when a project is being disabled. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when a project is being enabled. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when a project is being deleted. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
...
Event hook called when a change in project's settings was detected. The response of your app is ignored.
_This event is currently sent only to `project` and `eshop` apps._
