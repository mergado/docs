...
Your app (extension) communicates with Mergado via [our API](https://api-docs.mergado.com/?api=mergado-api). In exchange, Mergado also needs to **actively communicate with your app**.
...
### `control.shop.keychain.link_created`
Event hook called when a when a user creates a connection in the e-shop’s keychain.
<span title="The response of your app is ignored.">¹</span>
...
### `control.shop.keychain.link_deleted`
Event hook called when a when a user deletes a connection from the e-shop’s keychain.
<span title="The response of your app is ignored.">¹</span>
