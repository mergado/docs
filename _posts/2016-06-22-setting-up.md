...
## Registering a new app (extension)

Before you register a new app (extension), you need to figure out a name, a type of the app and other information:
